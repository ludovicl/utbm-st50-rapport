...
\begin{document}
\includepdf[fitpaper=true, pages=-]{couv.pdf}
\tableofcontents

\input{Chapters/intro.tex}
\input{Chapters/partie1.tex}
\input{Chapters/partie2.tex}
\input{Chapters/partie2-2.tex}
\input{Chapters/partie3.tex}
...
\bibliography{biblio}
\includepdf[fitpaper=true, pages=-]{end.pdf}
